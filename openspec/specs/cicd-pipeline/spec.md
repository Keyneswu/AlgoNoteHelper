...
## Purpose
Continuous integration and image-based continuous deployment for AlgoNoteHelper: GitHub Actions runs tests, publishes immutable container images to GHCR, and production pulls those images without rebuilding on the host or wiping database volumes.
